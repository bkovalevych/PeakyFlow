...
namespace PeakyFlow.Abstractions.UnitTests
{
    public class ModelsTests
    {
        ...
        public void TestFiannaces()
        {
            ...
            {
                new AssetEntry("0", "Savings", 40),
                new LiabilityEntry("1", "Children", 48),
                new LiabilityEntry("3", "Home Mortgage", 14300),
                new LiabilityEntry("4", "Education", 0),
                new LiabilityEntry("5", "Car payment", 1500),
                new LiabilityEntry("6", "Credit car payment", 2200),
                new LiabilityEntry("7", "Retail payment", 100)
